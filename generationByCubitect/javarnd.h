...
static inline int nextInt(int64_t *seed, const int n)
{
    ...
    if(((unsigned int)m & (unsigned int)n) == 0) return (int) ((n * (unsigned long)next(seed, 31)) >> 31u);
...
static inline long long firstInt24(int64_t seed)
{
    seed ^= 0x5deece66d;
...
static inline long long secondInt24(int64_t seed)
{
    seed ^= 0x5deece66d;
